...
export default class News extends React.Component {
  ...
  searchNewsAPI = (event) => {
    this.setState({
      ...
      url: `https://newsapi.org/v2/top-headlines?country=ie&category=business&apiKey=${apiKey}`
  ...
  static async getInitialProps(response) {
    ...
    const defaultUrl = `https://newsapi.org/v2/top-headlines?country=ie&category=business&apiKey=${apiKey}`;
