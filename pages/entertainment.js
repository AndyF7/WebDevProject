...
const defaultNewsSource = 'mtv-news-uk';
...
export default class News extends React.Component {
  ...
  setNewsSource = (input) => {
    this.setState({
      newsSource: input,
      url: `https://newsapi.org/v2/top-headlines?sources=mtv-news-uk&apiKey=1221cec2942d47008e680bf5ed04757a`
  ...
  static async getInitialProps(response) {
    const defaultUrl = `https://newsapi.org/v2/top-headlines?sources=mtv-news-uk&apiKey=1221cec2942d47008e680bf5ed04757a`;
